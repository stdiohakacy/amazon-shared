import { Duration, DateTime, DateObjectUnits } from 'luxon';
import { Injectable } from '@nestjs/common';
import { HelperDateServiceInterface } from '../interfaces/helper.date-service.interface';
import { HelperDateCreateOptionsInterface } from '../interfaces/helper.interface';
import { ENUM_HELPER_DATE_DAY_OF } from '../enums/helper.enum';

@Injectable()
export class HelperDateService implements HelperDateServiceInterface {
  private readonly defTz: string = 'Asia/Jakarta';
